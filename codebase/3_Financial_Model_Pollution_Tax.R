...
#This script includes the PGE Financial Model -- Pollution Tax Scenario
#-- Variable NG
...
Price <- read.csv("data/tax/Simulated_Price_Variable_NG.csv", header = FALSE) 
...
Model_gen_cost = 0 #Internal Accounting Parameter
...
#Tax on Thermal Plants Source Zeighami et al (2023)
...
for(yr in 1:N_years) {
  ...
  Total_market_sales = sum(Market_sales)
  ...
  Total_market_buy = sum(Market_buy) 
